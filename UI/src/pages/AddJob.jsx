        ...
        if (validate()) {
            try {
                ...
                if (imageFile) {
                    ...
                    const response = await fetch('https://elevate-career-backend.onrender.com/JobImage/upload', {
                        method: 'POST',
                        body: imageData,
                    });
                ...
                const jobResponse = await fetch('https://elevate-career-backend.onrender.com/graphql', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        query,
